...
public class UserReg {
    ...
    public ArrayList<String> CSusers = new ArrayList<>();
    ...
    public UserReg() {
        try {
            CSDB = new Scanner(new FileReader("/home/zsolt/Dropbox/CS MSC/athens-team-project/CSDB"));
            while (CSDB.hasNext()) {
    ...
    public void verifyRegistration(String username) {
        ...
        try {
            SetUpDBConnection UOBSOCS = new SetUpDBConnection(connection);
            UOBSOCS.initiate();
            setConnection(UOBSOCS.getConnection());
