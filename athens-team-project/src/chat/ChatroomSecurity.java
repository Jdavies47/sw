...
public class ChatroomSecurity {
	...
	/***
	 * This method generate a hash code for a input string
	 * @param strSrc, the input string
	 * @return the hash code of this string.
	 */
	public String Encrypt_SHA1(String strSrc) {
	...
	/***
	 * This method transfer a byte value to a hex value as string.
	 * @param bts, the input byte value
	 * @return a hex value as a String.
	 */
	...
	public static void main(String[] args){
		...
		System.out.println(s.Encrypt_SHA1("Wei Hua"));
	}
