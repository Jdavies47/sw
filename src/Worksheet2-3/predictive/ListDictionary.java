 ...
 * in an ArrayList of predictive.WordSig.
...
public class ListDictionary implements Dictionary {
     ...
     * ArrayList of predictive.WordSig (pairs of word+their signature values).
     * Uppercase words are converted to lowercase words.
     * The ArrayList is then sorted using the predictive.WordSig class's compareTo method.
     */
